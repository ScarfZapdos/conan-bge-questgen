(define (domain bge)
    ...
    (:action escort
        ...
        :effect (and (at ?p ?locB) (at ?charA ?locB) (not (at ?p ?locA)) (not (at ?charA ?locA)) (increase (total-cost) 6)))
    ...
    (:action killforitem
        ...
        :effect (and (has ?loc ?i) (dead ?charA) (increase (total-cost) 2)))
    ...
    (:action killforinfo
        ...
        :effect (and (has ?p ?info) (dead ?charA) (increase (total-cost) 2)))
    ...
    (:action spy
        ...
        :effect (and (has ?p ?info) (increase (total-cost) 0)))
